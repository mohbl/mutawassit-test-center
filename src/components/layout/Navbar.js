          ...
          <DrawerContent
            ...
            <DrawerBody>
              <Text
                  ...
                  fontSize="lg"
              >
                <Link onClick={onClose} to="/about">عن المركز</Link>
              </Text>
              <Text
                  fontFamily="diodrum-bold !important"
                  mt={{ base: 4, md: 0 }}
                  ...
                  fontSize="lg"
              >
                <Link onClick={onClose} to="/enthropology">المختار الإنثربولوجي</Link>
              </Text>
              ...
              <Text
                  ...
                  fontSize="lg"
              >
                <Link onClick={onClose} to="/cultureStudies">
                  دراسات ثقافية
                </Link>
              </Text>
              ...
              <Text
                  ...
                  fontSize="lg"
              >
                <Link onClick={onClose} to="/books?category=دراسات المركز">
                  كتب المركز
                </Link>
              </Text>
